    ...
    <main>
      ...
      <section className="pt-16 pb-12 bg-[#F4E4D4]">
        <div className="max-w-screen-2xl mx-auto px-6 md:px-12 mb-8 reveal">
          <h2 className="text-xl md:text-[26px] font-serif font-normal tracking-[0.08em] text-[#A4741C] uppercase">
            {t("the_selection")}
          </h2>
        </div>
              ...
              {rootCategories.map((category, i) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 p-8 md:p-10 z-10 w-full">
                    <span className="block text-[#ECA40C] text-[10px] md:text-xs tracking-[0.2em] font-bold uppercase mb-2">Selection</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              {collections.map((product, i) => (
                <div
                  ...
                  style={i > 0 ? { transitionDelay: `${i * 200}ms` } : undefined}
                >
                  <div className="relative aspect-4/3 overflow-hidden bg-[#F4E4D4]">
      ...
      {/* Skin Community */}
      <section className="py-24 bg-[#F4E4D4]">
        <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
          <div className="mb-10 reveal">
            <h2 className="text-2xl md:text-3xl font-serif font-normal text-[#A4741C] mb-2">Mango Moments</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 gap-4 lg:h-150">
            ...
            <Link href="/rituals" className="relative rounded-3xl overflow-hidden group cursor-pointer lg:row-span-2 aspect-4/3 lg:aspect-auto reveal">
              ...
              <span className="absolute top-4 left-4 bg-white/90 text-[#0A0A0A] text-[9px] font-bold tracking-widest uppercase px-3 py-1.5 rounded-full">Editorial</span>
            </Link>
            ...
            {/* CTA tile */}
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="relative rounded-3xl overflow-hidden bg-mango flex flex-col justify-between p-6 aspect-4/3 lg:aspect-auto reveal delay-150">
              <span className="w-10 h-10 rounded-full bg-charcoal/15 flex items-center justify-center">
                <InstagramIcon className="w-5 h-5 text-charcoal" />
              </span>
              <div>
                <h3 className="text-charcoal font-serif text-2xl mb-2">The Orchard</h3>
                <p className="text-charcoal/75 text-xs mb-5">Connect with our community on Instagram.</p>
      ...
      <section className="py-24 bg-[#F4E4D4]">
        <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-14 reveal gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-serif font-normal text-[#A4741C] uppercase mb-3">The Edit</h2>
            ...
            <Link href="/rituals" className="inline-flex items-center justify-center px-6 py-3.5 bg-accent text-white text-[10px] md:text-xs tracking-[0.15em] uppercase hover:bg-charcoal transition duration-300 rounded-full font-bold shadow-md shrink-0">
              View Journal
              <ArrowRight className="w-4 h-4 ml-3" />
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article className="group cursor-pointer reveal">
              ...
              <h3 className="text-lg md:text-xl font-serif font-semibold uppercase tracking-tight text-[#0A0A0A] mb-3 group-hover:text-accent transition">The Art of Sun-Drying</h3>
              ...
              <Link href="/rituals" className="inline-flex items-center gap-3 text-[10px] tracking-widest uppercase font-bold text-[#0A0A0A] group-hover:text-accent transition">
                Read Entry
                <span className="w-7 h-7 rounded-full border border-[#0A0A0A]/20 flex items-center justify-center group-hover:border-accent transition"><ArrowRight className="w-3.5 h-3.5" /></span>
              </Link>
            </article>
            ...
            <article className="group cursor-pointer reveal delay-100">
              ...
              <h3 className="text-lg md:text-xl font-serif font-semibold uppercase tracking-tight text-[#0A0A0A] mb-3 group-hover:text-accent transition">Understanding Mango Varietals</h3>
            ...
            <article className="group cursor-pointer reveal delay-200">
              ...
              <h3 className="text-lg md:text-xl font-serif font-semibold uppercase tracking-tight text-[#0A0A0A] mb-3 group-hover:text-accent transition">Ways to Enjoy Dried Mango</h3>
