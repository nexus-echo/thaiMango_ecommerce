...
export default function AboutPage() {
  return (
    <main>
      {/* Hero Banner */}
      <section className="relative py-24 md:py-32 bg-[#502500] text-white overflow-hidden text-center">
      ...
      <section className="py-16 md:py-24 bg-[#FFF9E9] border-y border-cream">
        <div className="max-w-screen-2xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
